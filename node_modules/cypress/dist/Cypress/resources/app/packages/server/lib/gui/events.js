(function() {
  var Project, Updater, Windows, _, api, connect, dialog, errors, handleEvent, ipc, konfig, logger, logs, open, openProject, pkg, shell, user;
  ...
  handleEvent = function(options, bus, event, id, type, arg) {
    var apiUrl, onBus, onFocusTests, onSettingsChanged, onSpecChanged, onWarning, send, sendErr, sendNull, sendResponse;
